...
public class DriveSubsystem extends SubsystemBase {
    ...
    private final Encoder leftEncoder = new Encoder(Components.ENC_LEFT_A, Components.ENC_LEFT_B, true);
    private final Encoder rightEncoder = new Encoder(Components.ENC_RIGHT_A, Components.ENC_RIGHT_B, true);
