...
public class Robot extends TimedRobot {
	...
	public void robotInit() {
		...
		addPeriodic(() -> { robotContainer.leds.pumpAnimation(); }, 2 / 1000);
	}
	...
	public void autonomousInit() {
		this.autonomous = this.robotContainer.getAutonomousCommand();
	...
	public void teleopInit() {
		...
		this.robotContainer.getRunningTeleopCommand().schedule();
	}
