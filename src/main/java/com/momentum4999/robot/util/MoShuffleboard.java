...
public class MoShuffleboard {
	...
	static {
		...
		directives.put("Average Distance",
				new LayoutDirective(driveLayout, (widget) -> widget.withWidget(BuiltInWidgets.kTextView)
						.withPosition(0, 0)));
		directives.put("Left Distance",
				new LayoutDirective(driveLayout, (widget) -> widget.withWidget(BuiltInWidgets.kTextView)
						.withPosition(0, 1)));
		directives.put("Right Distance",
				new LayoutDirective(driveLayout, (widget) -> widget.withWidget(BuiltInWidgets.kTextView)
						.withPosition(1, 1)));
		directives.put("Gyro Degrease" /* WTF is that spelling? */,
				new LayoutDirective(driveLayout, (widget) -> widget.withWidget(BuiltInWidgets.kTextView)
						.withPosition(1, 0)));

		// Shooter
		ShuffleboardLayout shootLayout = Shuffleboard.getTab("MoSystems").getLayout("Shooter", BuiltInLayouts.kGrid)
				.withSize(2, 3).withPosition(4, 0).withProperties(Map.of("Label Position", "Top"));
		directives.put("Flywheel Motor A Velocity",
				new LayoutDirective(shootLayout, (widget) -> widget.withWidget(BuiltInWidgets.kTextView)
						.withPosition(0, 0)));
		directives.put("Flywheel Motor B Velocity",
				new LayoutDirective(shootLayout, (widget) -> widget.withWidget(BuiltInWidgets.kNumberBar)
						.withPosition(1, 0)));
		directives.put("Current Hood Dist",
				new LayoutDirective(shootLayout, (widget) -> widget.withWidget(BuiltInWidgets.kTextView)
						.withPosition(0, 1)));
		directives.put("Shooter State",
				new LayoutDirective(shootLayout, (widget) -> widget.withWidget(BuiltInWidgets.kTextView)
						.withPosition(1, 1)));
		directives.put("Full of Ball",
				new LayoutDirective(shootLayout, (widget) -> widget.withWidget(BuiltInWidgets.kBooleanBox)
						.withPosition(0, 2)));
